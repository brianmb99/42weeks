...
The goal is a year of **living elsewhere**, not continuous vacation: meaningful cultural immersion, outdoor life, family time, strong academics, productive work for both parents, and recurring communities for the children.

### Current shape of the year
...
- The family intends to take the 2027–28 academic year away from normal life in New Hampshire.
- Brian expects to work remotely for a solid **eight hours most workdays**, but the schedule is flexible. It may follow U.S., European, or Hong Kong hours—or a split day—depending on what best fits each location and family life.
- The children's academic backbone will probably be **structured homeschooling for roughly three hours per day**, potentially supplemented by local programs and place-based learning.
- Christmas is expected to be at **Snowbird**.
- Spring is expected to use **Denmark as a roughly three-month home base**.
- A winter international school is not required. **Verbier International School is ruled out** because of cost and cultural fit.
- The family strongly prefers longer bases and routine over frequent moves.

## Major open decisions

### 1. Fall: Australia, then India
...
- Can India work as a stable base with side trips, rather than a month of continuous travel?
...
The Alpine location is **not settled**. Crans-Montana is a developed lead, not a commitment. Previously considered locations include Verbier, Chamonix, Lech/Zürs, and Val d’Isère; the search may extend beyond these.

Selection criteria:

- High-quality U12 race and/or freestyle training accessible to visiting children
- Social continuity and recurring peers
- Strong family skiing and dependable snow
- Functional town life rather than a purely luxury-resort atmosphere
- Housing with space, kitchen, laundry, ski storage, and a real workspace
- Excellent internet and a quiet room for U.S.-hours work
- Walkability or easy lift/bus access; minimal daily driving
- Reasonable access to an airport
- Value for money
- A workable immigration, remote-work, tax, and insurance structure

Crans-Montana leads already explored:

- ACM race consortium — Nicolas Combe
- Ski Fun+ freestyle track — Laurence Meyer

Both children will be U12 during the 2027–28 season.

### 3. Spring: Denmark and European travel

The intended structure is to spend about three months based in Denmark after using approximately 90 Schengen days in Switzerland or elsewhere.

The working immigration theory relies on the **U.S.–Denmark bilateral visa-waiver arrangement** for additional time in Denmark. This needs authoritative confirmation for the family's exact sequence and documentation.

The family would also like to travel from Denmark to other Schengen countries during this period. This may fall outside what the bilateral arrangement legally permits. Lack of routine internal border checks does not make such travel lawful, and temporary controls or other encounters remain possible. Treat this as an **unresolved legal and risk decision**, not an approved assumption.

Questions to resolve:

- Exact entry/exit sequence and documentation for invoking the Danish bilateral arrangement
- Whether any travel elsewhere in Schengen is legally available during the Denmark extension
- Consequences and practical exposure if the family travels beyond Denmark anyway
- Lawful alternatives that preserve regional travel
- Best Danish home base for family life, youth sports, academics, and airport access

## Family requirements

### Children and education

- Maintain or exceed current progress in mathematics, writing, and reading
- Use history, science, art, geography, and languages tied to each location
- Preserve a clear path back into Crossroads Academy
- Build independence and adaptability
- Ensure recurring contact with other children through skiing, sports, classes, or local groups
- Avoid requiring both parents to improvise full-time schooling while also working

### Skiing

- Serious and frequent training for both children
- Race and freestyle opportunities are both valuable
- Familiarity with one mountain and community is more important than resort-hopping
- Adult terrain matters, but children's development and daily family life come first

### Work

Brian's requirements:

- Employer approval for each country
- Legal and regulatory clearance for cross-border remote work
- Extremely reliable internet
- Dedicated desk, monitors, and a quiet room
- A solid eight hours of work on most workdays, with flexibility to pause for dinner, homeschooling, or another family block
- Some useful overlap with colleagues, but not continuous U.S.-hours collaboration; the team spans New York, Chicago, London, and Hong Kong
- Freedom to choose U.S., European, Hong Kong, or split hours according to the location—for example, skiing in an Alpine morning and working later with a dinner break
- Stable bases during heavy working periods

Sabbatical requirements for Brian's wife:

- Protected research and writing time
- Potential access to universities, collaborators, and libraries
- A decision on whether any formal visiting affiliation would add value

### Housing and daily life

- At least two bedrooms; three preferred for longer stays
- Kitchen, laundry, dependable heating/cooling, and strong internet
- Separate workspace
- Walkable access to shops, activities, school/sports, or transit
- Ski and outdoor-equipment storage in winter
- Enough space and routine to remain happy for months

## Legal and practical workstreams

- Immigration and visa sequence across Australia, India, Switzerland/Europe, and Denmark
- Employer authorization, remote-work legality, tax residency, and permanent-establishment risk
- Health, travel, evacuation, and liability insurance
- Homeschooling and school-reentry requirements
- Housing and transportation for each base
- Handling or shipping ski gear and other long-stay luggage
- Whether to rent, house-sit, or leave vacant the Hanover home
- Mail, vehicles, insurance, maintenance, and snow removal at home
- Flights and points strategy; likely departure airports are BOS, MHT, and BTV, with Chase points available
- A realistic all-in budget and booking calendar

## Success tests

The plan is working if:

- The children make friends, progress academically, and become stronger skiers
- Both adults have genuinely productive working time
- U.S.-hours work does not erase family evenings
- The family experiences ordinary local life, not only tourism
- There is substantial outdoor time and some practical language learning
- Transitions are infrequent enough to preserve energy and routine
- Reentry to school, work, and home life is manageable
...
|---|---|
| Jul 2026 | Alps reopened as a genuine location decision; Crans-Montana is only a candidate. |
| Jul 2026 | Verbier International School ruled out on cost and vibe. |
| Jul 2026 | Fall concept revised to roughly two months in Australia plus one month in India. |
| Jul 2026 | Fall order set as Australia Sep–Oct, India Nov, United States/Snowbird/Christmas Dec; this supersedes the older Australia-through-November concept. |
| Jul 2026 | Melbourne footy made a September priority; October shifts to one Queensland long-term base. |
| Jul 2026 | India cricket added as a November objective, contingent on fixtures not yet published. |
| Jul 2026 | Diwali 2027 identified as Friday, October 29; early-November spillover remains relevant. |
| Jul 2026 | Australia extended back into late August to preserve two full months: Melbourne plus one Queensland long-term base, with Hamilton Island as a short side vacation while retaining the rental. |
| Jul 2026 | India arrival anchored for October 26–27, ahead of Diwali rather than during the holiday travel peak. |
| Jul 2026 | Work requirement clarified as eight solid hours with flexible timing and limited overlap needs, rather than fixed U.S. East Coast hours. |
...
- Exact dates for every leg
- Alpine candidate list and scoring weights
- Australian bases and children's activities
- Dehradun family stay, other Indian base(s), selective tourist itinerary, and work setup
- Snowbird dates and lodging
- Danish city/region and youth sports
- Curriculum and daily/weekly family rhythm
- Housing budget by leg
- Vehicle and transit plan
- Home-management plan for Hanover
